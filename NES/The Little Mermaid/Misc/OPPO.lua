...
gui.text(ariel[1],ariel[2]+10,round(math.sqrt(arielxvel*arielxvel+arielyvel*arielyvel),1).." subpx/s","white","black")
end 
...
pyth1=256*(memory.readbyte(0x0330)+256*memory.readbyte(0x0340))+memory.readbyte(0x320) -- PRIORITIZE RIGHT
--pyth1=(256*256)*(memory.readbyte(0x0340)+1)-(256*memory.readbyte(0x330)+memory.readbyte(0x320)) -- PRIORITIZE LEFT

pyth2=256*(memory.readbyte(0x0360)+256*memory.readbyte(0x0370))+memory.readbyte(0x350) -- PRIORITIZE BOTTOM
--pyth2=(256*256)*(memory.readbyte(0x0370)+1)-(256*memory.readbyte(0x360)+memory.readbyte(0x350)) -- PRIORITIZE TOP
...
gui.text(0,9,math.sqrt(pyth1*pyth1+pyth2*pyth2)) -- 
 ...
 gui.text(160,192,bit.band(memory.readbyte(0xE4)+memory.readbyte(0xE7)+1,0x0F))

...
function Stage2()
 ...
 for i=0,maxframes-tablesum(forkframe),1 do
  ...
  printRNG(" After Crab 4: ")	
	...
	if crab3pos=="Right" and crab3timer==64 and crab4pos=="Mid" and crab4timer==64 then
     table.insert(forkframe,i)
...
while finished==0 do
 advanceRNG(1491)     -- From start of game to Starfish Generator
 ...
 for i=0,maxframes,1 do
  ...
  starfish()
  advanceRNG(287)     -- From Starfish Generator to Shark room

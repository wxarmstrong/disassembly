...
function breakTest()
	...
	if reg_X~=0x00 and tileState==0x00 then
		breakFlag = true;
	end
...
QBertConditions = {
	...
	Lose = function () return memory.readbyte(0x79) > 0x20 or breakFlag == true end,
	MinTurns = function()
		places = {0x04,
		          0x0B, 0x0C, 
				  0x13, 0x14, 0x15,
...
QBertActions = {
	...
	Left = {
		Priority = function()
			...
			--Left side of screen
			if (tilePos==0x0B or tilePos==0x13 or tilePos==0x1A or tilePos==0x22 or tilePos==0x29 or tilePos==0x31) then return 1 end

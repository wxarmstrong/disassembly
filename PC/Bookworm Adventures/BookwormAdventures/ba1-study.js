...
function newBoard(){
	...
	function customBoard() {
	  ...
	  function submitWord(){
		var xyz = document.getElementById("xyz0");
		...
		var xyz = document.getElementById("xyz1");
		if (xyz.checked)
		{
			value["X"] = 2.5;
			value["Y"] = 2.5;
		...
		var xyz = document.getElementById("xyz2");
		if (xyz.checked)
		{
			value["X"] = 3;
			value["Y"] = 3;
		...
		var parrot = document.getElementById("parrotoff");
		if (parrot.checked)
		{
			value["R"] = 1;
		}
		
		var parrot = document.getElementById("parroton");
		if (parrot.checked)
		{
			value["R"] = 2;
		}
		...
		if (!wordValid(wordString)){
			...
			if (isMetal(pruneQ(wordString))){

				alert.innerHTML += " <b>(Metal Bonus)<b>";
